...
description: "Use antigravity-awesome-skills with Jetski/Cortex without hitting context-window overflow with 1.378+ skills."
---

# Jetski/Cortex + Gemini: safe integration with 1,1.378+ skills
...
With over 1,1.378 skills, this approach fills the context window before user messages are even added, causing truncation.
